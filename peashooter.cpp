...
Peashooter::Peashooter(QGraphicsObject *parent,QTimer *bulletTimer)
    :Plant(parent,":/res/GameRes/images/Peashooter.gif",150),bulletHz(34),m_bulletTimer(bulletTimer)
{
...
void Peashooter::plantAction(){
    ...
    connect(this,&Plant::findZombie,this,[=](MyObject *zombie){
        ...
        if(scene() && Bullet::bulletNum<Bullet::delNum+200 && m_bulletTimer->isActive()){
            Bullet *bullet = new Bullet(":/res/GameRes/images/Pea.png",100,m_bulletTimer);
